...
__vue_options__.__file = "E:\\www\\weex\\test\\node_modules\\weex-ui\\packages\\wxc-rich-text\\wxc-rich-text-text.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-4ed6c4a4"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-7ddcf222"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-756740ae"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
__vue_options__.__file = "E:\\www\\weex\\test\\src\\index.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-4dae1bcd"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
var _jsMd = __webpack_require__(24);

var _jsMd2 = _interopRequireDefault(_jsMd);

var _weexUi = __webpack_require__(26);
...
exports.default = {
  name: 'App',
  components: {
    Title: _title2.default, WxcMinibar: _weexUi.WxcMinibar, WxcTabBar: _weexUi.WxcTabBar, Utils: _weexUi.Utils, WxcLoading: _weexUi.WxcLoading, WxcButton: _weexUi.WxcButton, WxcEpSlider: _weexUi.WxcEpSlider, WxcProgress: _weexUi.WxcProgress, WxcResult: _weexUi.WxcResult, WxcRadio: _weexUi.WxcRadio, WxcMask: _weexUi.WxcMask, WxcTabPage: _weexUi.WxcTabPage, WxcPanItem: _weexUi.WxcPanItem
  },
  data: function data() {
    return {
      token: _config2.default.MyToken,
      menuid: 1,
      myquest: 0, // 题目编号
      errorshow: false,
      errortype: 'noNetwork',
      ...
      tabStylesPage: _config2.default.tabStylesPage,
      contentStyle: 'justify-content: flex-start;',
      title: _config2.default.App_Title,
      App_Server: _config2.default.App_Server,
      Img_Server: _config2.default.Img_Server,
      menuData: null,
      listData: null,
      progress_value: 0,
      progress_time: -1,
  ...
  methods: {
    is_load_info: function is_load_info() {
      if (this.isShow) {
        modal.toast({
          'message': '读取读取中，请稍等...',
          'duration': 1
    ...
    wxcMaskSetHidden: function wxcMaskSetHidden(e) {
      this.isShow4 = false;
    },
    wxcButtonClick3: function wxcButtonClick3(e) {
      if (this.is_load_info()) return;
      var me = this;
      clearTimeout(this.timeOut);
      var myValue = void 0;
      for (var index = 0; index < this.cardLength; index++) {
        var element = this.listData[index].SelectItem;
        if (myValue == null) {
          myValue = element;
        } else {
          myValue += ',' + element;
      ...
      var myurl = 's=' + myValue + '&t=' + this.progress_time + '&token=' + this.token;
      myurl = myurl + '&c=' + (0, _jsMd2.default)(myurl);
      console.log('element', myValue, 'progress_time', this.progress_time, 'myurl', myurl);
      var SET_QUEST_JSONP = _config2.default.App_Server + 'api/quest?type=set&mid=' + this.menuid + '&id=' + this.myquest + '&' + myurl + '&token=' + this.token;
      this.isShow = true;
      stream.fetch({
        method: 'GET',
        url: SET_QUEST_JSONP,
    ...
    wxcRadioListChecked: function wxcRadioListChecked(e) {
      ...
      var SelectItem = this.listData[this.SelectPage].SelectItem;
    ...
    wxcTabBarCurrentTabSelected: function wxcTabBarCurrentTabSelected(e) {
      ...
      var me = this;
      var GET_INFO_JSONP = void 0;
      if (this.SelectMenu == 1) {
        // 排名榜
        GET_INFO_JSONP = _config2.default.App_Server + 'api/quest?type=pai_ming&token=' + this.token;
      } else if (this.SelectMenu == 2) {
        // 用户信息
        GET_INFO_JSONP = _config2.default.App_Server + 'api/quest?type=user&token=' + this.token;
      } else {
        return;
      }
      this.isShow = true;
    ...
    wxcButtonClicked: function wxcButtonClicked(id) {
      //读取题目展示
      if (this.is_load_info()) return;
      var me = this;
      ...
      var GET_LIST_JSONP = _config2.default.App_Server + 'api/quest?type=list&mid=' + id + '&token=' + this.token;
      this.isShow1 = false;
      this.isShow = true;
      stream.fetch({
        method: 'GET',
  ...
  created: function created() {
    var me = this;
    var GET_MENU_JSONP = _config2.default.App_Server + 'api/quest?type=menu&token=' + this.token;
    stream.fetch({
      method: 'GET',
      url: GET_MENU_JSONP,
      type: 'jsonp'
...
(function () {
  ...
  var AMD = "function" === 'function' && __webpack_require__(25);
...
var _bindEnv = __webpack_require__(27);
...
var _wxcCell = __webpack_require__(9);

var _wxcCell2 = _interopRequireDefault(_wxcCell);

var _wxcCheckbox = __webpack_require__(41);

var _wxcCheckbox2 = _interopRequireDefault(_wxcCheckbox);

var _wxcCheckboxList = __webpack_require__(46);

var _wxcCheckboxList2 = _interopRequireDefault(_wxcCheckboxList);

var _wxcCity = __webpack_require__(50);
...
var _wxcFullPage = __webpack_require__(96);

var _wxcFullPage2 = _interopRequireDefault(_wxcFullPage);

var _wxcGridSelect = __webpack_require__(101);

var _wxcGridSelect2 = _interopRequireDefault(_wxcGridSelect);

var _wxcIcon = __webpack_require__(110);
...
var _wxcLightbox = __webpack_require__(116);
...
var _wxcLotteryRain = __webpack_require__(130);
...
var _wxcRichText = __webpack_require__(196);
...
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-6664a1de"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-1e3a1581"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-b51f236c"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
var _defaultData = __webpack_require__(54);
...
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-5719638d"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-ab5afa70"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-89bd3388"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
var _type = __webpack_require__(68);
...
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-28b40b8d"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-26d0c40e"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-0fd961a7"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-439021a6"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-62b7cfa0"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
var _fullPage = __webpack_require__(97);
...
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-78f281e1"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-7ab72e00"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-8c40f692"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-6575d050"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-2ce0a8d4"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-5062a2ea"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-20165519"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-3c04db37"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
var _rainItem = __webpack_require__(134);
...
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-250ef491"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
var _region = __webpack_require__(139);
...
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-c5f11f8e"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-86da80d0"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-64802959"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
var _format = __webpack_require__(156);
...
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-cf46397c"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-1d5a6049"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-05f11c0c"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-57936cd8"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-f763c806"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-e3de9c36"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-08f6191b"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
exports.default = {
  components: {
    WxcRichTextText: __webpack_require__(10),
    WxcRichTextLink: __webpack_require__(203),
    WxcRichTextIcon: __webpack_require__(206),
...
var _wxcRichTextText = __webpack_require__(10);
...
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-2f29e20c"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-584fdef4"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-60f4f564"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-256f9a46"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-3d187307"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-6091e46e"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-c24d5210"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-239549b4"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-ad7f5512"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
  ...
  }, [_c('list', _vm._l((_vm.menuData), function(v, index) {
    return _c('cell', {
      appendAsTree: true,
      attrs: {
        "append": "tree"
    ...
    }, [_vm._v(_vm._s(v.title))])]), _c('image', {
      ref: "poster",
      refInFor: true,
      staticClass: ["questImage"],
      attrs: {
        "src": _vm.Img_Server + v.image
      }
    }), _c('text', {
      staticClass: ["text-container"]
    }, [_vm._v(_vm._s(v.content))]), _c('wxc-button', {
      staticClass: ["button"],
      attrs: {
        "text": " 开 始 ",
        "disabled": v.disabled
    ...
    staticClass: ["wtprogress"]
  }, [_c('text', {
    staticClass: ["progress-text", "left"]
  }, [_vm._v("答题进度")]), _c('wxc-progress', {
    attrs: {
      "value": _vm.progress_value,
      "barWidth": 500
    }
  }), _c('text', {
    staticClass: ["progress-text", "right"]
  }, [_vm._v(_vm._s(_vm.progress_value) + "%")])], 1), _c('div', {
    staticClass: ["wtprogress"]
  }, [_c('text', {
    staticClass: ["progress-text", "left"]
  }, [_vm._v("答题时间")]), _c('text', {
    staticClass: ["progress-text"]
  }, [_vm._v(_vm._s(_vm.progress_time) + " 秒")]), _c('wxc-button', {
    directives: [{
      name: "show",
      rawName: "v-show",
      value: (_vm.isShow3),
    ...
    on: {
      "wxcButtonClicked": _vm.wxcButtonClick3
    }
  })], 1), _c('wxc-ep-slider', {
    ref: "wxc-ep-slider",
    attrs: {
  ...
  }, _vm._l((_vm.listData), function(v, index) {
    return _c('div', {
      key: index,
      ...
      staticClass: ["category-text"]
    }, [_vm._v("第 " + _vm._s(index + 1) + " 题：" + _vm._s(v.q_content))])]), _c('wxc-radio', {
      attrs: {
        "list": v.list
      },
      on: {
    ...
    ref: "wxc-tab-page",
    attrs: {
      "tabStyles": _vm.tabStylesPage,
      "tabTitles": _vm.UserPaiMing.title,
      "titleType": "text"
    },
    on: {
      "wxcTabPageCurrentTabSelected": _vm.wxcTabPageCurrentTabSelected
    }
  }, _vm._l((_vm.UserPaiMing.users), function(v, index) {
    return _c('list', {
      key: index
    }, [_c('scroller', {
      staticClass: ["scroller"]
      ...
      }, [_c('wxc-pan-item', [_c('div', {
        staticClass: ["wtprogress"]
      }, [_c('text', [_vm._v(" 第 " + _vm._s(key + 1) + " 名 ")]), _c('div', {
      ...
      })]), _c('text', [_vm._v(_vm._s(demo.name))])]), _c('div', [_c('text', [_vm._v("分数：" + _vm._s(demo.u_value))]), _c('text', [_vm._v("时间：" + _vm._s(demo.u_time))]), _c('text', {
        staticClass: ["usertime"]
      }, [_vm._v(_vm._s(demo.updated_at))])])])])], 1)
    })], 2)])
  }))], 1), _c('div', {
    staticClass: ["item-container"],
    style: _vm.contentStyle
    ...
    staticClass: ["useravatar"],
    attrs: {
      "src": _vm.UserInfo.user.avatar
    }
  })]), _c('text', [_vm._v(_vm._s(_vm.UserInfo.user.name))]), _c('list', {
    staticClass: ["item-container"],
    style: {
      height: (_vm.deviceHeight - _vm.tabStyles.height) + 'px'
    }
  }, _vm._l((_vm.UserInfo.title), function(v, index) {
    return _c('cell', {
      key: index,
      appendAsTree: true,
      attrs: {
      ...
      staticClass: ["title"]
    }, [_vm._v(_vm._s(v.title))]), (v.user) ? _c('div', {
      staticClass: ["content"]
    }, [_c('text', [_vm._v("我的排名：第 " + _vm._s(v.user.paiming) + " 名")]), _c('text', [_vm._v("最好成绩： " + _vm._s(v.user.u_value) + " 分")]), _c('text', [_vm._v("成绩时间： " + _vm._s(v.user.u_time) + " 秒")]), _c('text', [_vm._v("答题次数： " + _vm._s(v.user.count) + " 次")])]) : _c('div', {
      staticClass: ["content"]
    }, [_c('text', [_vm._v("暂无排名")])])])
  }))], 1)]), _c('wxc-result', {
    attrs: {
